...
//int i2c_address = BME680_I2C_ADDR_PRIMARY; // used i2c address 0x76
int i2c_address = BME680_I2C_ADDR_SECONDARY; // used i2c address 0x77
char *filename_state = "bsec_iaq.state";
char *filename_config = "bsec_iaq.config";
char *logfile_path = "/var/log/bsec_bme680.log";
                  ...
                  float breath_voc_equivalent)
{
  ...
  // Write log file in the following format
  // Local date and time;IAQ Accuracy;IAQ Value;Temperature C;Humidity %;Pressure hPa;Gas Resistance ohms;CO2 Value ppm;bVOC Value ppm
